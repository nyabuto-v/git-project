...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__profile_service__ = __webpack_require__("./src/app/profile.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_5__profile_service__["a" /* ProfileService */]],
...
var ProfileService = /** @class */ (function () {
    function ProfileService(http) {
        this.http = http;
        this.clientid = '88349eee8071659d6a69';
        this.clientsecret = '4fd3e72b5d0c887d7f0deb0cf8814f585bbcf1c0';
        console.log("service is now ready!");
        this.username = 'nyabuto-v';
    }
    ProfileService.prototype.getProfileInfo = function () {
        return this.http.get("http://api.github.com/users/" + this.username + "?client_id=" + this.clientid + "&client_secret=" + this.clientsecret).map(function (res) { return res.json(); });
    };
